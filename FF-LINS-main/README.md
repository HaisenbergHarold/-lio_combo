...
roslaunch ff_lins ff_lins_read.launch configfile:=$(pwd)/src/FF-LINS-main/config/ff_lins_robot.yaml bagfile:=/mnt/d/BinPeng/datasets/FF_LINS/park/park.bag
```
...
```
roslaunch ff_lins ff_lins_read.launch configfile:=$(pwd)/src/FF-LINS-main/config/ff_lins_lili.yaml \
 bagfile:=/mnt/d/BinPeng/datasets/lili/schloss1.bag
```
